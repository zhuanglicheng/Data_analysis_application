...
'''
C:\学习\Python数据分析应用\tutorial>python manage.py makemigrations snippets
Migrations for 'snippets':
  snippets\migrations\0002_auto_20200611_1521.py
    - Add field highlighted to snippet
    - Add field owner to snippet

C:\学习\Python数据分析应用\tutorial>python manage.py migrate
C:\学习\Python数据分析应用\tutorial>python manage.py createsuperuser
Username: wen111
Email address: 1010@qq.com
Password:
Password (again):
